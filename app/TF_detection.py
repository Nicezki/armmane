...
from model.rmutt_model1 import config as cf
...
class ArduinoCommu:
    def __init__(self):
        self.arduino = ser.Serial('/dev/ttyACM0', 9600)
        time.sleep(2)
...
def configload():
    config_file_path = "/model/rmutt_model1/config.json"
    with open(config_file_path, 'r') as f:
        cf = json.load(f)
    return cf

def labelload():
    labels = cf["model_classes"]
    return labels

# Load model 
def modelload():
    PATH_TO_CKPT= os.path.join(getpath(),MODEL_NAME,GRAPH_NAME)
